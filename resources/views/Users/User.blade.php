                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="kelas_id" id="kelas" class="form-control select2"
                                            ...
                                            @forelse (App\Models\Kelas::all() as $value)
                                                <option value="{{ $value->rombongan_belajar_id }}">{{ $value->kelas }}
                                                </option>
                                            @empty
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="text-sm-end">
                                            <button type="button" class="btn btn-secondary mb-2 me-1"
                                                id="importDapodik">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#importDapodik").on("click", (e) => {
                ...
                $.post("{{ route('apiUser', 'koalaToken') }}", function() {})
                    .fail(function(data) {
                        $("#importDapodik").toggleClass("disabled");
                        $("#importIcon").toggleClass("d-none");
                        $("#importSpinner").toggleClass("d-none");
