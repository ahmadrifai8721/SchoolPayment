        ...
        <div class="container-fluid">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="mb-0 text-muted"><i
                                                    class="mdi mdi-arrow-down-bold text-success"></i>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="mb-0 text-muted"><i
                                                    class="mdi mdi-arrow-up-bold text-success"></i>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h4 class="mt-0 mb-1 font-20">$12,500</h4>
                                            <p class="mb-0 text-muted"> Saldo Hari Ini
                                            </p>
                                        </div>
                                    </div>
                                </div> <!-- end card-body -->
                            ...
                            <div class="card">
                                <div class="card-header align-items-center d-sm-flex justify-content-sm-between">
                                    ...
                                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a href="#day-status" data-bs-toggle="tab" aria-expanded="false"
                                                class="nav-link py-1 active">
                                                <span class="">Day</span>
                                            </a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a href="#week-status" data-bs-toggle="tab" aria-expanded="false"
                                                class="nav-link py-1">
                                                <span class="">Week</span>
                                            </a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a href="#month-status" data-bs-toggle="tab" aria-expanded="false"
                                                class="nav-link py-1">
                                                <span class="">Month</span>
                                            </a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a href="#year-status" data-bs-toggle="tab" aria-expanded="false"
                                                class="nav-link py-1">
                                ...
                                <div class="card-body pt-0">
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="day-status" role="tabpanel"
                                            aria-labelledby="day-status-tab">
                                            <div dir="ltr">
                                                <div id="day-balance-chart" class="apex-charts" data-colors="#0acf97">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="week-status" role="tabpanel"
                                            aria-labelledby="week-status-tab">
                                            <div dir="ltr">
                                                <div id="week-balance-chart" class="apex-charts" data-colors="#0acf97">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="month-status" role="tabpanel"
                                            aria-labelledby="month-status-tab">
                                            <div dir="ltr">
                                                <div id="month-balance-chart" class="apex-charts" data-colors="#0acf97">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="year-status" role="tabpanel"
                                            aria-labelledby="year-status-tab">
                                            <div dir="ltr">
                                                <div id="year-balance-chart" class="apex-charts" data-colors="#0acf97">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-xxl-3">
                    <div class="row">
                        <div class="col-md-6 col-xxl-12">
                            <div class="card bg-primary card-bg-img"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-4">
                                            <p class="text-white-50 font-16 mb-1">Date Now</p>
                                            <h4 class="text-white my-0" id="date-now"></h4>
                                            <script>
                                                const date = new Date()
                                        ...
                                        <div class="col-4">
                                            <p class="text-white-50 font-16 mb-1">UID</p>
                        ...
                        <div class="col-md-6 col-xxl-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h4 class="header-title">payment requests</h4>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                                    class="mdi mdi-cached me-1"></i>Refresh</a>
                                            <!-- item-->
                                            <a href="javascript:void(0);" class="dropdown-item"><i
                                ...
                                <div class="card-body pt-0 mb-2" data-simplebar style="max-height: 319px;">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0 text-success"><i class="mdi mdi-question me-1"></i>10%
                                        </p>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xxl-3">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="header-title mb-0">quick payment</h4>
                        ...
                        <div class="card-body py-0 mb-2" data-simplebar style="max-height: 388px;">
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span
                                            class="avatar-title bg-transparent border border-light text-danger rounded">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 my-0 fw-semibold text-secondary">Dribbble <i
                                            class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="font-16 text-muted"><i
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span
                                            class="avatar-title bg-transparent border border-light text-info rounded h3 my-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 my-0 fw-semibold text-secondary">Behance <i
                                            class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="font-16 text-muted"><i
                                        class="uil uil-angle-right-b"></i></a>
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span
                                            class="avatar-title bg-transparent border border-light text-primary rounded h3 my-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 my-0 fw-semibold text-secondary">Facebook <i
                                            class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="font-16 text-muted"><i
                                        class="uil uil-angle-right-b"></i></a>
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span
                                            class="avatar-title bg-transparent border border-light text-danger rounded h3 my-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 my-0 fw-semibold text-secondary">Instagram
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span
                                            class="avatar-title bg-transparent border border-light text-dark rounded h3 my-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 my-0 fw-semibold text-secondary">Github <i
                                            class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="font-16 text-muted"><i
                                        class="uil uil-angle-right-b"></i></a>
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span
                                            class="avatar-title bg-transparent border border-light text-success rounded h3 my-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 my-0 fw-semibold text-secondary">Google <i
                                            class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="font-16 text-muted"><i
                                        class="uil uil-angle-right-b"></i></a>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 my-0 fw-semibold text-secondary">Pinterest
                                        <i class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="font-16 text-muted"><i
                                        class="uil uil-angle-right-b"></i></a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img class="rounded-circle"
                                                            src="assets/images/users/avatar-2.jpg" alt="Avtar image"
                                                            width="33">
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        Peter Wallace
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img class="rounded-circle"
                                                            src="assets/images/users/avatar-3.jpg" alt="Avtar image"
                                                            width="33">
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        Jacob Dunn
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img class="rounded-circle"
                                                            src="assets/images/users/avatar-4.jpg" alt="Avtar image"
                                                            width="33">
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        Terry Adams
                                            ...
                                            <td>
                                                <span class="badge bg-warning-lighten text-warning">In
                                                    Progress</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img class="rounded-circle"
                                                            src="assets/images/users/avatar-5.jpg" alt="Avtar image"
                                                            width="33">
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                                        Jason Stovall
...
<!-- Wallet Dashboard js -->
<script src="{{ url('/') }}/assets/js/pages/demo.dashboard-wallet.js"></script>
@endsection
